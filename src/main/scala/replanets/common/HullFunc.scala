...
case object HeatsTo50 extends HullFunc(3, "Heats to 50", "HeatsTo50")
case object CoolsTo50 extends HullFunc(4, "Cools to 50", "CoolsTo50")
case object HeatsTo100 extends HullFunc(5, "Heats to 100", "HeatsTo100")
